			...
			<div class="col-lg-5">
				...
				<form>
					...
					<div class="form-check mb-3">
						...
						<a href="/forget-password" class="float-end" style="text-decoration: none;">Forget Password?</a>
					</div>
					<button class="btn btn-primary w-100 mb-2" style="background-color: #003F7D; border: none;" type="submit">Sign
						in</button>
				</form>
